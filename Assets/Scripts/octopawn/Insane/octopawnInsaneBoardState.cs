...
public class octopawnInsaneBoardState : MonoBehaviour
{
    ...
    void Update()
    {   
        numberofPlayerPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAIMove>().playerPawnNumber;
        numberofAIPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<octopawnInsanePlayerMove>().AIPawnNumber;
        playerPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnInsanePlayerMove>().pawnOneCantMove;
        playerPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnInsanePlayerMove>().pawnTwoCantMove;
        playerPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnInsanePlayerMove>().pawnThreeCantMove;
        playerPawnFourCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnInsanePlayerMove>().pawnFourCantMove;
        AIPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAIMove>().pawnOneCantMove;
        AIPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAIMove>().pawnTwoCantMove;
        AIPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAIMove>().pawnThreeCantMove;
        AIPawnFourCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAIMove>().pawnFourCantMove;
        playerLoseOnTime = GameObject.FindWithTag("GameController").GetComponent<octopawnInsanePlayerMove>().timeLoss;
        playerPawnCheck();
        AIPawnCheck();
        if(playerLoseOnTime)
        {
