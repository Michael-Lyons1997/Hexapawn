...
public class octopawnInsaneAIMove : MonoBehaviour
{
    ...
    public octopawnInsanePlayerMove playerScript;
    ...
    void Start()
    {
        playerScript = GameObject.FindWithTag("GameController").GetComponent<octopawnInsanePlayerMove>();
    ...
    void Update()
    {
        ...
        movePawnOne = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAI>().pawnOneMove;
        movePawnTwo = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAI>().pawnTwoMove;
        movePawnThree = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAI>().pawnThreeMove;
        movePawnFour = GameObject.FindWithTag("GameController").GetComponent<octopawnInsaneAI>().pawnFourMove;
        if(AITurn)
        {
