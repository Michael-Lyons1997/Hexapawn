...
public class octopawnHardAIMove : MonoBehaviour
{
    ...
    public octopawnHardPlayerMove playerScript;
    ...
    void Start()
    {
        playerScript = GameObject.FindWithTag("GameController").GetComponent<octopawnHardPlayerMove>();
    ...
    void Update()
    {
        ...
        movePawnOne = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAI>().pawnOneMove;
        movePawnTwo = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAI>().pawnTwoMove;
        movePawnThree = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAI>().pawnThreeMove;
        movePawnFour = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAI>().pawnFourMove;
        if(AITurn)
        {
