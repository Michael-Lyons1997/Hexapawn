...
public class octopawnHardBoardState : MonoBehaviour
{
    ...
    void Update()
    {   
        numberofPlayerPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAIMove>().playerPawnNumber;
        numberofAIPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<octopawnHardPlayerMove>().AIPawnNumber;
        playerPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnHardPlayerMove>().pawnOneCantMove;
        playerPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnHardPlayerMove>().pawnTwoCantMove;
        playerPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnHardPlayerMove>().pawnThreeCantMove;
        playerPawnFourCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnHardPlayerMove>().pawnFourCantMove;
        AIPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAIMove>().pawnOneCantMove;
        AIPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAIMove>().pawnTwoCantMove;
        AIPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAIMove>().pawnThreeCantMove;
        AIPawnFourCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnHardAIMove>().pawnFourCantMove;
        playerLoseOnTime = GameObject.FindWithTag("GameController").GetComponent<octopawnHardPlayerMove>().timeLoss;
        playerPawnCheck();
        AIPawnCheck();
        if(playerLoseOnTime)
        {
