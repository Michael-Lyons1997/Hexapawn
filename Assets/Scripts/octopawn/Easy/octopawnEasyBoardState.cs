...
public class octopawnEasyBoardState : MonoBehaviour
{
    ...
    void Update()
    {   
        numberofPlayerPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyAIMove>().playerPawnNumber;
        numberofAIPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyPlayerMove>().AIPawnNumber;
        playerPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyPlayerMove>().pawnOneCantMove;
        playerPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyPlayerMove>().pawnTwoCantMove;
        playerPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyPlayerMove>().pawnThreeCantMove;
        playerPawnFourCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyPlayerMove>().pawnFourCantMove;
        AIPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyAIMove>().pawnOneCantMove;
        AIPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyAIMove>().pawnTwoCantMove;
        AIPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyAIMove>().pawnThreeCantMove;
        AIPawnFourCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyAIMove>().pawnFourCantMove;
        playerLoseOnTime = GameObject.FindWithTag("GameController").GetComponent<octopawnEasyPlayerMove>().timeLoss;
        playerPawnCheck();
        AIPawnCheck();
        if(playerLoseOnTime)
        {
