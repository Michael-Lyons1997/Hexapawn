...
public class octopawnMediumBoardState : MonoBehaviour
{
    ...
    void Update()
    {   
        numberofPlayerPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumAIMove>().playerPawnNumber;
        numberofAIPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumPlayerMove>().AIPawnNumber;
        playerPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumPlayerMove>().pawnOneCantMove;
        playerPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumPlayerMove>().pawnTwoCantMove;
        playerPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumPlayerMove>().pawnThreeCantMove;
        playerPawnFourCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumPlayerMove>().pawnFourCantMove;
        AIPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumAIMove>().pawnOneCantMove;
        AIPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumAIMove>().pawnTwoCantMove;
        AIPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumAIMove>().pawnThreeCantMove;
        AIPawnFourCantMove = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumAIMove>().pawnFourCantMove;
        playerLoseOnTime = GameObject.FindWithTag("GameController").GetComponent<octopawnMediumPlayerMove>().timeLoss;
        playerPawnCheck();
        AIPawnCheck();
        if(playerLoseOnTime)
        {
