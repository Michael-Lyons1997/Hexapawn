...
public class hardBoardState : MonoBehaviour
{
    ...
    void Update()
    {   
        numberofPlayerPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<hardAIMove>().playerPawnNumber;
        numberofAIPawnsLeft = GameObject.FindWithTag("GameController").GetComponent<hardPlayerMove>().AIPawnNumber;
        playerPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<hardPlayerMove>().pawnOneCantMove;
        playerPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<hardPlayerMove>().pawnTwoCantMove;
        playerPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<hardPlayerMove>().pawnThreeCantMove;
        AIPawnOneCantMove = GameObject.FindWithTag("GameController").GetComponent<hardAIMove>().pawnOneCantMove;
        AIPawnTwoCantMove = GameObject.FindWithTag("GameController").GetComponent<hardAIMove>().pawnTwoCantMove;
        AIPawnThreeCantMove = GameObject.FindWithTag("GameController").GetComponent<hardAIMove>().pawnThreeCantMove;
        playerLoseOnTime = GameObject.FindWithTag("GameController").GetComponent<hardPlayerMove>().timeLoss;
        playerPawnCheck();
        AIPawnCheck();
        if(playerLoseOnTime)
        {
