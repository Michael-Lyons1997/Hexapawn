        ...
        if(!playerMoved)
        {
            ...
            if(movePawnOne)
            {
                if(PawnOneOnA1)
                {
                    ...
                    else if(!otherPawnOneOnB1 && !otherPawnTwoOnB1)
                    {
            ...
            if(movePawnTwo)
            {
                if(PawnTwoOnA2)
                {
                    ...
                    else if(!otherPawnOneOnB2 && !otherPawnTwoOnB2 && !otherPawnThreeOnB2)
                    {
            ...
            if(movePawnThree)
            {
                if(PawnThreeOnA3)
                {
                    ...
                    else if(!otherPawnTwoOnB3 && !otherPawnThreeOnB3)
                    {
